...
UPDATE Users SET weight_kg = 58.0 WHERE user_id = 1;

UPDATE Goals SET status = 'Completed' WHERE goal_id = 401;


DELETE FROM Workout_Exercise WHERE workout_id = 210 AND exercise_id = 109;

DELETE FROM DietPlans WHERE diet_id = 510;